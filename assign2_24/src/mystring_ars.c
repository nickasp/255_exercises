/*********************** ASPRIDIS_NIKOLAOS *************** ASSIGNMENT_2 ****************** mystring_ars.c ********************/
 ...
 *
 *Checked runtime errors: 'my_str' to be NULL.
 *Parameters: my_str --> the string of which the length is counted
